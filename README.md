...
### 功能
![](http://processon.com/chart_image/5eae92cf6376897466a21714.png)

### 架构
![](http://processon.com/chart_image/5ec13710f346fb6907fd86fe.png)
...
<h2 id=5>五、比较有特色的函数</h2>  
  ...
  3. ReportWindow
   报表窗口实现了翻页功能，即便应对大量数据也不会因为渲染而卡顿

<h2 id=6>六、存在的不足与对策</h2>
